...
-	Once Java has been installed, download the zip file containing the game classes. To dowload the zip file, click on "Demo3.zip", then click "view raw" and follow the directions to download this file.
